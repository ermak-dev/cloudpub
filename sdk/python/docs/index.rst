...
- **Списки контроля доступа (ACL)**: Контроль доступа к сервисам на основе ролей пользователей
- **Пользовательские HTTP заголовки**: Добавление пользовательских заголовков в HTTP/HTTPS ответы
- **Правила фильтрации**: Определение правил для управления маршрутизацией запросов и доступом
